...
INSERT INTO HEROES
SELECT 1, 'Iron Man', 'Tony Stark', 'The Merchant of Death',
 'Avengers', 'HIGH',
...
UNION ALL SELECT 2, 'Captain America', 'Steve Rogers', 'The First Avenger',
 'Avengers', 'LOW',
...
UNION ALL SELECT 3, 'Black Widow', 'Natasha Romanoff', 'Natalia Alianovna Romanova',
 'Avengers', 'HIGH',
...
UNION ALL SELECT 4, 'Hulk', 'Bruce Banner', 'The Green Goliath',
 'Avengers', 'CRITICAL',
...
UNION ALL SELECT 5, 'Thor', 'Thor Odinson', 'God of Thunder',
 'Avengers', 'MEDIUM',
...
UNION ALL SELECT 6, 'Spider-Man', 'Peter Parker', 'The Web-Slinger',
 'Avengers', 'LOW',
...
UNION ALL SELECT 7, 'Black Panther', 'T''Challa', 'King of Wakanda',
 'Avengers', 'MEDIUM',
...
UNION ALL SELECT 8, 'Scarlet Witch', 'Wanda Maximoff', 'The Scarlet Witch',
 'Avengers', 'HIGH',
...
UNION ALL SELECT 9, 'Doctor Strange', 'Stephen Strange', 'Sorcerer Supreme',
 'Avengers', 'MEDIUM',
...
UNION ALL SELECT 10, 'Hawkeye', 'Clint Barton', 'The Marksman',
 'Avengers', 'LOW',
...
SELECT 1, 'Stark Industries', 'ORGANISATION',
...
UNION ALL SELECT 2, 'Hulk', 'INDIVIDUAL',
...
UNION ALL SELECT 3, 'Loki Laufeyson', 'INDIVIDUAL',
...
UNION ALL SELECT 4, 'HYDRA', 'ORGANISATION',
...
UNION ALL SELECT 5, 'Sokovia', 'ORGANISATION',
...
UNION ALL SELECT 6, 'Ten Rings', 'ORGANISATION',
...
UNION ALL SELECT 7, 'Wanda Maximoff', 'INDIVIDUAL',
...
UNION ALL SELECT 8, 'Oscorp Industries', 'ORGANISATION',
...
UNION ALL SELECT 9, 'Wakanda Royal Family', 'ORGANISATION',
...
UNION ALL SELECT 10, 'Red Room', 'ORGANISATION',
...
UNION ALL SELECT 11, 'Merchant of Death', 'INDIVIDUAL',
...
UNION ALL SELECT 12, 'Winter Soldier', 'INDIVIDUAL',
